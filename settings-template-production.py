...
# Django settings for PyGoWave. Template for production servers.
...
if os.name == "nt":
	...
	CLIENT_CACHE_FOLDER = "/var/cache/pygowave_client/"
...
# STOMP RPC specific
STOMP_PORT = 61613
STOMP_MODE = "client" # Possible values: "client" (use message broker), "server" (no message broker)
